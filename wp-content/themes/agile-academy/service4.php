    ...
    <header id="header" class=" bg-cover  bg-[#033A54] lg:h-[340px] h-[260px] flex flex-col  w-[100%]">
        <div class="xl:p-[80px] lg:px-[48px] lg:py-[80px] py-[40px] px-[16px]">
            ...
            <p class="text-white lg:text-[56px] text-[32px] " style="font-family: Merriweather_Black;">
                Agile Readiness & Health Assessment</p>
        </div>
    ...
    <section class="px-[16px] py-[48px] lg:py-[80px] lg:px-[40px] xl:p-[80px]">
        <div class=" flex flex-col lg:flex-row justify-between items-center">
            <div class="xl:mr-[150px] lg:mb-[0px] mb-[48px]">
                ...
                <p class="text-[#4F5B66] md:text-[18px] text-[16px]" style="font-family: Open_Sans;">Agile Academy conducts state-of-the-art Agile Readiness Assessments that pinpoint areas that need to be worked on before the transformation begins. The Assessment also highlights “low hanging fruit” or areas that can be built on quickly to optimize the existing agility within. 

                    Agile Academy is the main partner for AgilityHealth® in the Middle East and Africa.  AgilityHealth® is the world’s leading agile health measurement, assessment, and growth platform. We utilize AgilityHealth® radars and assessment platforms to provide powerful, insightful, and strategic health assessments to our clients. 
