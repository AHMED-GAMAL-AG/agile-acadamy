<footer class=" bg-cover  bg-[#02283B]  flex flex-col  w-[100%]">
                ...
                <div class="md:order-2 lg:order-1 order-2 lg:w-[40%] w-full lg:pr-[50px]">
                    ...
                    <div class="lg:flex-col md:flex-row flex flex-col">
                        <div class="flex md:flex-row flex-col lg:mb-[88px] md:mr-[220px] lg:mr-[0px]">
                            <input type="text" class="block lg:w-[285px] p-2 h-[56px] md:mr-[16px] mb-[10px] border border-white rounded-[4px] text-white bg-[#02283B] text-[16px] focus:border-white dark:focus:border-white dark:border-white" style="font-family: Open_Sans;" placeholder="Enter your email">
    ...
    <script src="<?php echo get_template_directory_uri() ?>/owlcarousel/dist/owl.carousel.min.js"></script>
