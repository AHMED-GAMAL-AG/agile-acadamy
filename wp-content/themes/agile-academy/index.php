        ...
        <div class="  flex lg:flex-row flex-col w-full items-center justify-center px-[40px] xl:px-[0px]">
            <div class="  py-[123px] flex flex-col">
                ...
                <div class="flex flex-row">
                    <a href="contact-us.html"> <button type="button" class="text-white rounded-[4px] mr-[16px] text-[18px]  bg-[#C34849] hover:bg-[#923031]  text-center  py-[10px] md:px-[32px] px-[24px]" style="font-family:Open_Sans_Bold; ">Contact us</button></a>
                    <button type="button" class="text-white rounded-[4px] text-[18px]  bg-[#033A54] hover:bg-white hover:text-[#033A54] border border-white  text-center  py-[10px] md:px-[32px] px-[24px]" style="font-family:Open_Sans_Bold; ">Learn more</button>
                </div>
            </div>
