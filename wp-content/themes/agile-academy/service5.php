...
<section class="px-[16px] py-[48px] lg:py-[80px] lg:px-[40px] xl:p-[80px]">
    <div class=" flex flex-col lg:flex-row justify-between items-center">
        <div class="xl:mr-[150px] lg:mb-[0px] mb-[48px]">
            ...
            <p class="text-[#4F5B66] md:text-[18px] text-[16px]" style="font-family: Open_Sans;">We believe that one of the key aspects of successful and agile transformations is establishing a strong Agile internal capability that will enable organizations to excel and move forward in a sustainable manner rather than a temporary one. 
                We have educational, mentoring, and coaching tracks for key roles such as Agile Coaches, Scrum Masters, Product Owners, Managers, HR, Leadership teams…etc. Agile Academy specifically takes pride in our unique and distinguished program for developing Agile Coaches and Scrum Masters. These learning roadmaps are complemented by Agility Health Assessment Radars which enable continuous monitoring and measurement for the growth of different Agile Talent within an organization (e.g., Teams, Scrum Masters, Agile Coaches, Product Owners, Agile Leaders).</p>
