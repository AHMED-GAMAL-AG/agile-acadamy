            ...
            <div class="flex lg:order-2 ">
                ...
                <div class="relative hidden lg:block mr-[16px]">
                    ...
                    <input type="text" id="search-navbar"
                        ...
                        class="absolute left-0 z-10 mt-2 w-[403px] bg-white  shadow-md hidden"
                      >
                        ...
                        <div class="hidden lg:block">
                            ...
                            <div id="dropdownNavbar"
                                ...
                                <ul class="py-2 text-sm text-[#4F5B66]" aria-labelledby="dropdownLargeButton">
                                    <li>
                                        <a href="<?php echo home_url()?>/service1"
                                            class="block px-4 py-2 hover:bg-[#F2FBFF]"
                                            style="font-family: Open_Sans; font-weight: 400;">Enterprise Business
                                            Agility Transformation</a>
                                    </li>
                                    <li>
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-[24px]">
                        ...
                        <div class="flex">
                            ...
                            <button data-modal-hide="authentication-modal" data-modal-show="register-modal" data-modal-target="register-modal"><p class="text-[#C34849] text-[14] underline" style="font-family:OpenSans_Bold;">Create account</p></button>
                        </div>
                                ...
                                <input type="email" name="email" id="email" class="border border-[#CAD6E0] rounded-[4px] w-full" style="font-family: Open_Sans;" placeholder="Email" required>
                                      ...
                                      <div class="relative" x-data="{ isVisible: false }">
                                        ...
                                        <label for="password1" class="block">
                                           <input type="password" id="password1" placeholder="password" minlength="5" style="font-family: Open_Sans;"
                                            class="border border-[#CAD6E0] rounded-[4px] w-full"
                                      ...
                                      <button data-modal-hide="authentication-modal" data-modal-show="forgetPassword-modal" data-modal-target="forgetPassword-modal"><p class=" pb-[40px] text-[#C34849] text-[14] underline" style="font-family:OpenSans_Bold;">Forgot password?</p><button>

                            <button type="submit"  class="text-white rounded-[4px] text-[18px] bg-[#C34849] hover:bg-[#923031] w-full text-center  py-[10px] px-[32px] "
                            style="font-family:Open_Sans_Bold; ">Log in</button>
                            <div class="flex flex-row ">
                                <hr class=" w-[45%] my-[28px] border-[#CAD6E0]">
                                <p class="text-[#CAD6E0] my-[16px] px-[5px] text-[14px] "style="font-family:Open_Sans;" >Or</p>
                                <hr class=" w-[45%] my-[28px] border-[#CAD6E0]">
                             </div>
                             <button   class="text-[#0F1F26] rounded-[4px] lg:text-[18px] text-[14px] bg-white hover:bg-[#0F1F26] hover:text-white w-full text-center  py-[10px] px-[16px]  border border-[#CAD6E0] mb-[24px]"
                             style="font-family:Open_Sans_Bold; "><div class="flex "><img class="pr-[39px]" src="<?php echo get_template_directory_uri()?>/assets/images/Google-colored-icon.svg" ><p class="text-center"> Continue with Google</p></div></button>
                             <button   class="text-[#0F1F26] rounded-[4px] lg:text-[18px] text-[14px] bg-white hover:bg-[#0F1F26] hover:text-white w-full text-center  py-[10px] px-[16px]  border border-[#CAD6E0] mb-[24px]"
                             style="font-family:Open_Sans_Bold; "><div class="flex "><img class="pr-[39px]" src="<?php echo get_template_directory_uri()?>/assets/images/Facebook-Colored-icon.svg" ><p class="text-center"> Continue with Facebook</p></div></button>
                             <button   class="text-[#0F1F26] rounded-[4px] lg:text-[18px] text-[14px] bg-white hover:bg-[#0F1F26] hover:text-white w-full text-center  py-[10px] px-[16px]  border border-[#CAD6E0] "
                             style="font-family:Open_Sans_Bold; "><div class="flex "><img class="pr-[39px]" src="<?php echo get_template_directory_uri()?>/assets/images/colored-twitter.svg" ><p class="text-center"> Continue with Twitter</p></div></button>
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-[24px]">
                        ...
                        <div class="flex">
                            ...
                            <button data-modal-hide="register-modal" data-modal-show="authentication-modal" data-modal-target="authentication-modal"><p class="text-[#C34849] text-[14] underline" style="font-family:OpenSans_Bold;">Log in</p></button>
                        </div>
                        <form class="pt-[24px]" action="#">
                            <div class="pb-[24px]">
                            ...
                            <div class="pb-[24px]">
                                <input type="email" name="email" id="email" class="border border-[#CAD6E0] rounded-[4px] w-full" style="font-family: Open_Sans;" placeholder="Email" required>
                                      ...
                                      <button data-modal-hide="register-modal" data-modal-target="forgetPassword-modal"
                                      data-modal-show="forgetPassword-modal"><p class=" pb-[40px] text-[#C34849] text-[14] underline" style="font-family:OpenSans_Bold;">Forgot password?</p></button>

                            <button type="submit"  class="text-white rounded-[4px] text-[18px] bg-[#C34849] hover:bg-[#923031] w-full text-center  py-[10px] px-[32px] "
                            style="font-family:Open_Sans_Bold; ">Create account</button>
                            <div class="flex flex-row ">
                                <hr class=" w-[45%] my-[28px] border-[#CAD6E0]">
                                <p class="text-[#CAD6E0] my-[16px] px-[5px] text-[14px] "style="font-family:Open_Sans;" >Or</p>
                                <hr class=" w-[45%] my-[28px] border-[#CAD6E0]">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-[24px]">
                        ...
                        <form class="pt-[24px]" action="#">
                            ...
                            <button data-modal-target="emailSent-modal" data-modal-show="emailSent-modal" data-modal-hide="forgetPassword-modal" type="submit"  class="text-white rounded-[4px] text-[18px] bg-[#C34849] hover:bg-[#923031] w-full text-center  py-[10px] px-[32px] "
                            style="font-family:Open_Sans_Bold; ">Send link</button>
        ...
        <div id="emailSent-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative  max-w-md max-h-full w-[400px] ">
                ...
                <div class="relative bg-white rounded-lg shadow">
                   ...
                   <button data-modal-hide="emailSent-modal" data-modal-target="newPassword-modal" data-modal-show="newPassword-modal"> <div class="p-[24px]" >
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-[24px]">
                        ...
                        <form class="pt-[24px]" action="#">
                            ...
                            <button data-modal-hide="newPassword-modal" data-modal-target="passwordReset-modal" data-modal-show="passwordReset-modal" type="submit"  class="text-white rounded-[4px] text-[18px] bg-[#C34849] hover:bg-[#923031] w-full text-center  py-[10px] px-[32px] "
                            style="font-family:Open_Sans_Bold; ">Reset password</button>
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-[24px]" >
                        ...
                        <p class="mb-[39px] text-[24px] text-[#0F1F26] text-start" style="font-family:Merriweather_Bold ;">Forgot password</p>
                         ...
                         <button data-modal-hide="passwordReset-modal" data-modal-target="authentication-modal" data-modal-show="authentication-modal"  class="text-white rounded-[4px] text-[18px] bg-[#C34849] hover:bg-[#923031] w-full text-center  py-[10px] px-[32px] "
