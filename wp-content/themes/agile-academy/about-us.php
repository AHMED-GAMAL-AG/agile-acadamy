...
<body class="box-border">
    ...
    <header id="header" class=" bg-cover  bg-[#033A54] h-[340px]  flex flex-col  w-[100%]">
        <div class="xl:p-[80px] lg:px-[48px] lg:py-[80px] py-[40px] px-[16px]">
            <div class="flex flex-row pb-[16px] lg:pt-[0px] pt-[50px]">
                ...
                <p class="text-white text-[14px]" style="font-family: Open_Sans_Bold;"> > About us</p>
            </div>
    ...
    <section class="xl:p-[80px] lg:py-[80px] lg:px-[40px] py-[40px] px-[16px]">
        <div class="flex xl:flex-row flex-col justify-between items-center">
            <div class="xl:w-[620px] xl:mr-[150px]">
                ...
                <p class="text-[#4F5B66] md:text-[18px] text-[16px]" style="font-family: Open_Sans;">
                    Agile Academy is a UAE-based Consultancy company with an international presence yet focusing on the
                    Middle East and Africa. At Agile Academy, we offer a wide range of services including Enterprise
                    Business Agility Transformations, Role-based Capability Building programs, internationally
                    accredited training classes (Public and in-house), customized experiential workshops, Agile team
    ...
    <section class="xl:p-[80px] lg:py-[80px] lg:px-[40px] py-[40px] px-[16px]">
        <div class="flex xl:flex-row flex-col justify-between items-center w-full">
            ...
            <div class="xl:w-[620px] xl:order-2 order-1">
                ...
                <p class="text-[#4F5B66] md:text-[18px] text-[16px] pb-[48px]" style="font-family: Open_Sans;">
                    Our purpose & vision is about inspiring & transforming individuals, teams & organizations towards a
                    higher purpose that enables them to create a bigger impact on their customers.
                </p>
    ...
    <section class="bg-[#F2FBFF] xl:py-[120px] xl:px-[80px] lg:py-[80px] lg:px-[40px] px-[16px] py-[40px]">
        <p class="text-center text-[32px] lg:pb-[64px] pb-[48px]" style="font-family:Merriweather_Black;">What
            differentiates us
        </p>
        <div class="flex xl:flex-row flex-col justify-between">
            ...
            <div class="xl:w-[620px]">
                ...
                <p class="text-start text-[16px] text-[#4F5B66] " style="font-family:Open_Sans;">Our consultants/coaches
                    have been helping organizations and leading agile transformation initiatives since 2008. Our team
                    has a unique blend of global world-class knowledge and expertise along with local understanding and
                    experience with the Middle Eastern culture. Our team has a unique and deep experience achieved by
                    working with a wide range of clients from local, regional and international markets, as well as
                    private and public sectors, spanning different domains and specialties such as: SW Development – IT
                    Operations – Telecom – Government – Banking – Leadership and Coaching – Healthcare –
                    PharmaceuticalsWe have trained 5,000+ professionals across 3 continents, and we have certified
                    2,500+ professionals in the last 7 years Our Principal Coaches have a unique mix of qualifications
                    and skills that enable them to bring aspects from different domains such as Professional Coaching,
                    Executive Coaching, Psychology, Organization Change, Individual Change theory, Business Agility,
                    Lean…etc. in a unique combination that has proven to be crucial for organizations undergoing Agile
                    Transformations</p>
        ...
        <div class="flex xl:flex-row flex-col justify-between">
            <div class="xl:w-[620px] xl:order-1 order-2 xl:mr-[260px]">
                <p class="text-[24px] pb-[16px]" style="font-family:Merriweather_Bold;">Our Unique Philosophy & Approach
                </p>
                <p class="text-start text-[16px] text-[#4F5B66] " style="font-family:Open_Sans;">Our philosophy &
                    approach in everything that we do is solely guided by our purpose. This enables any consultant/coach
                    from Agile Academy to truly inspire and create impact in environments and engagements where there’s
                    true potential for agility Our Coaches and Consultants navigate through complexity guided by a
                    strong set of values and principles that ensures we create the utmost value and impact to our
                    clients One element that is core to our approach is enabling organizations to develop and build
                    their own strong capability in Agile leadership and coaching, which would further enable them to
                    sustain their transformation journeys without overly relying on external consultancy We provide
                    full-fledge integrated capability building programs that are based on the 3Es framework [Education,
                    Exposure & Experience]. We believe that trainings (Education) are just the starting step for
                    building capability, and they must be followed by exposure and experience that’s achieved by close
                    coaching, mentoring, shadowing, and feedback. Agile Academy is the first company in the Middle East
                    and Africa to be accredited by the International Consortium for Agile. Our classes and programs are
                    internationally accredited from the International Consortium for Agile (ICAgile) [one of the top
                    accreditation bodies that provides an unrivaled education roadmap for all disciplines, specialties
                    and roles involved in an Agile organization] All our classes are highly experiential and
                    transformative Our classes are facilitated and led by 1-2 certified instructors/coaches who bring a
        ...
        <div class="flex xl:flex-row flex-col justify-between">
            ...
            <div class="xl:w-[620px]">
                ...
                <p class="text-start text-[16px] text-[#4F5B66] " style="font-family:Open_Sans;">Agile Academy was
                    founded by Amr Noaman, Mohamed Amr and Ahmed Sidky, 3 of the top Agile thought leaders in the Middle
                    East and Africa Our consultants are part of a global network of thought leaders who collaborate to
                    achieve global impact and inspiration across the world Our Co-founders (Amr and Mohamed) have
                    spoken in a wide range of international, regional, and local conferences and events (Global Agile
                    Conference (USA) – Global Scrum Gatherings (USA) – Agile Africa – Scrum Gathering South Africa –
                    Agile Middle East (Dubai) – Agile Lebanon – Agile Egypt – AMECSE (Middle East) and published various
                    articles, papers and most recently a book</p>
