    ...
    <header id="header" class=" bg-cover  bg-[#033A54] lg:h-[340px] h-[260px] flex flex-col  w-[100%]">
        <div class="xl:p-[80px] lg:px-[48px] lg:py-[80px] py-[40px] px-[16px]">
            <div class="flex flex-row pb-[16px] lg:pt-[0px] pt-[50px]">
                ...
                <p class="text-white text-[14px]" style="font-family: Open_Sans_Bold;"> > &nbsp</p>
                <p class="text-[#C34849] hover:text-[#923031] text-[14px] pr-[4px]" style="font-family: Open_Sans_Bold;">Coaching services</p>
    ...
    <section class="px-[16px] py-[48px] lg:py-[80px] lg:px-[40px] xl:p-[80px]">
        <div class=" flex flex-col lg:flex-row justify-between items-center">
            <div class="xl:mr-[150px] lg:mb-[0px] mb-[48px]">
                ...
                <p class="text-[#4F5B66] md:text-[18px] text-[16px]" style="font-family: Open_Sans;">While training and education are crucial to success, it’s only part of the equation. In Agile Academy, we offer a unique set of Agile coaching services to guide individuals and teams through their journey toward agility.
                    We don’t just coach individuals and teams on how to DO Agile, rather we coach them on how to BE Agile. We use the Integral Agile Model that tackles the following aspects when transforming a team: Individuals Aspect (Mindset) – Team Culture Aspect (We) – Team Practices Aspect (IT) – Team External Environment Aspect (Organization). 
